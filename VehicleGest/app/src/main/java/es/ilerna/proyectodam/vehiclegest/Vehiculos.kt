...
import es.ilerna.proyectodam.vehiclegest.databinding.ActivityVehiculosBinding
...
class Vehiculos : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navController = findNavController(R.id.nav_host_fragment_content_vehiculos)
